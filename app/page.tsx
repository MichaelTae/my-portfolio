    ...
    <motion.main className='flex-1  relative justify-center items-center  bg-transparent  '>
      <div className='flex z-10 absolute flex-col  sm:w-[100%] md:w-[100%] lg:w-[35%] right-0 p-4   pointer-events-none'>
        ...
        <motion.div
          ...
          whileInView={'show'}
          variants={fadeIn('top', 'ease', 0.5, 1)}
          className=' self-center min-[600px]:self-end lg:self-center '
        >
          <Image
            src='/123me.jpg'
