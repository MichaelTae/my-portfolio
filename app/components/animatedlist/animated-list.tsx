...
const AnimatedList = ({ items,setProjectChoice  }:{items:any, setProjectChoice: Function}) => {
    ...
    return(<motion.ul className="space-y-2 py-1 px-2"  variants={isNotMobile ? variants : variantsMobile}
        initial="hidden"
        animate="visible"
        exit="hidden">
